...
public class Person implements Serializable {
	...
	private boolean isValidPhoneNumber(String phoneNumber) {
		...
		Pattern pattern = Pattern.compile("([0-9]*)"); // zoberie jedine cisla
		Matcher matcher = pattern.matcher(phoneNumber); // porovnava s
														// "phoneNumber"

		if (matcher.matches()) // ak je zhoda zadaneho cisla so vzorom potom
								// TRUE
			return true;
		else // inak FALSE
			return false;
